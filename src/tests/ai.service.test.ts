...
const SPECIFIC_SUMMARY =
  '45 y/o male with persistent dull pain (5/10) w/ upper left abdominal discomfort x 3 days. No fever/nausea. Antacids ineffective. **Action Plan:** Scheduled for ultrasound on Wednesday a.m.';
...
const mockTranscriptionContent = {
  ...
  positiveCase:
    'The patient, a 45-year-old male, came in today reporting persistent discomfort in the upper left abdomen for the last three days.',
  // Lacks the keyword, triggering the default summary
  negativeCase:
    'The patient is reporting general fatigue and requested a refill for their blood pressure medication.',
};
